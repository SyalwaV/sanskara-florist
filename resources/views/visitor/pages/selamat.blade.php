    ...
    <section id="new-arrivals" class="new-arrivals">
        <div class="container">
            <div class="section-header">
                <h2>Bunga Papan Ucapan Selamat</h2>
            </div><!--/.section-header-->
            <div class="new-arrivals-content">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="single-new-arrival">
                            <div class="single-new-arrival-bg">
                                <img src="assets/images/slider/ed.png" alt="new-arrivals images">
                                <div class="single-new-arrival-bg-overlay"></div>
                            </div>
                            <h4><a href="#">blue and purple Congratulation</a></h4>
                            <p class="arrival-product-price">Rp.550.000</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3">
                        <div class="single-new-arrival">
                            <div class="single-new-arrival-bg">
                                <img src="assets/images/slider/eddding.png" alt="new-arrivals images">
                                <div class="single-new-arrival-bg-overlay"></div>
                            </div>
                            <h4><a href="#">blue and purple Congratulation</a></h4>
                            <p class="arrival-product-price">Rp.550.000</p>
