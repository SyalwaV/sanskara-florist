     ...
     <section id="new-arrivals" class="new-arrivals">
        <div class="container">
            <div class="section-header">
                <h2>Bunga Papan Ucapan Pernikahan</h2>
            </div><!--/.section-header-->
            <div class="new-arrivals-content">
                <div class="row">
                    <div class="col-md-3 col-sm-3">
                        <div class="single-new-arrival">
                            <div class="single-new-arrival-bg">
                                <img src="assets/images/slider/we.png" alt="new-arrivals images">
                                <div class="single-new-arrival-bg-overlay"></div>
                            </div>
                            <h4><a href="#">Blue Wedding Great Path</a></h4>
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="single-new-arrival">
                            <div class="single-new-arrival-bg">
                                <img src="assets/images/slider/wed.png" alt="new-arrivals images">
                                <div class="single-new-arrival-bg-overlay"></div>
                            </div>
                            <h4><a href="#">Sunshine Wedding</a></h4>
                            <p class="arrival-product-price">Rp.550.000</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="single-new-arrival">
                            <div class="single-new-arrival-bg">
                                <img src="assets/images/slider/ww.png" alt="new-arrivals images">
                                <div class="single-new-arrival-bg-overlay"></div>
                            </div>
                            <h4><a href="#">Glamoure wedding</a></h4>
                            <p class="arrival-product-price">Rp.550.000</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3">
                        <div class="single-new-arrival">
                            <div class="single-new-arrival-bg">
                                <img src="assets/images/slider/ee.png" alt="new-arrivals images">
                                <div class="single-new-arrival-bg-overlay"></div>
                            </div>
                            <h4><a href="#">Blue Pink Flower </a></h4>
                            <p class="arrival-product-price">Rp.550.000</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="single-new-arrival">
                            <div class="single-new-arrival-bg">
                                <img src="assets/images/slider/pernikahan.png" alt="new-arrivals images">
                                <div class="single-new-arrival-bg-overlay"></div>
                            </div>
                            <h4><a href="#">Fully Flowers</a></h4>
                            <p class="arrival-product-price">Rp.550.000</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3">
                        <div class="single-new-arrival">
                            <div class="single-new-arrival-bg">
                                <img src="assets/images/slider/nikah.png" alt="new-arrivals images">
                                <div class="single-new-arrival-bg-overlay"></div>
                            </div>
                            <h4><a href="#">Pinky Blue </a></h4>
